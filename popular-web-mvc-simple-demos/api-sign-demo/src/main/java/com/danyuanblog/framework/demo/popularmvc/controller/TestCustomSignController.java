...
import com.danyuanblog.framework.demo.popularmvc.security.MD5SignEncryptHandler;
...
@Api(tags = "测试接口自定义验签加签算法功能")
@RestController
@RequestMapping("custom")
@Slf4j
public class TestCustomSignController {
	...
	@RequiredSign(scope = SignScope.BOTH, type = MD5SignEncryptHandler.class)
